...
// Using the remainder operator allows for iteration over the array to evaluate the elements. This determines which data will allow for two to go into it evenly with no remainder leftover logging only the even numbers.
...
for (var i = 0; i < weather_options.length; i++) {
  console.log("Today will be" , weather_options[i]);
}
